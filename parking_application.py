...
def main():
    ...
    if st.button('提交'):
         threading.Thread(target=submit_application, args=(conn, cursor, unit, name, car_number, employee_id, special_needs, contact_info, previous1, previous2, current, local_db_path, db_file_id)).start()
         cursor.execute('''
